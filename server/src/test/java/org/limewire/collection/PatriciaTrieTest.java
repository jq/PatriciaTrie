...
public class PatriciaTrieTest extends TestCase {
    ...
    public void testSimple() {
        PatriciaTrie<Integer, String> intTrie = new org.limewire.collection.PatriciaTrie<Integer, String>(new IntegerKeyCreator());
    ...
    public void testCeilingEntry() {
        org.limewire.collection.PatriciaTrie<Character, String> charTrie = new org.limewire.collection.PatriciaTrie<Character, String>(new AlphaKeyCreator());
        charTrie.put('c', "c");
        charTrie.put('p', "p");
        charTrie.put('l', "l");
        charTrie.put('t', "t");
